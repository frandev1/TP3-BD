...
SELECT 
    TF.id AS idTF,                -- id de la Tarjeta F�sica
...
JOIN 
    TF ON TF.Numero = R.C.value('@TF', 'VARCHAR(20)'); -- Vincular con TF usando el n�mero de tarjeta
...
-- Activar nuevamente las restricciones de claves for�neas
